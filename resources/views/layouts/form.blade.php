...
<div class="mb-3 row">
  <label for="tanggal_lahir" class="col-md-3 col-form-label text-md-end">
  Tanggal Lahir *</label>
  <div class="col-md-6">
    <div class="row g-2">
      <div class="col-3">
      ...
      <div class="col-5">
        ...
        @endphp
        <select class="form-select col-md-4 d-inline
        @error('tanggal_lahir') is-invalid @enderror"
...
<div class="mb-3 row">
  <label for="pekerjaan" class="col-md-3 col-form-label text-md-end">
  Pekerjaan </label>
  <div class="col-md-6">
